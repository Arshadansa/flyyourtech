...
function Navbar() {
  return (
    <nav className="font-display  dark:bg-gray-900">
      <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2  md:gap-4 ">
          ...
          <div
            id="dropdownHover"
            className="z-10 hidden bg-white shadow-lg shadow-white divide-y divide-gray-100 rounded-lg  w-44 dark:bg-gray-700"
          >
            <ul
