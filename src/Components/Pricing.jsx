    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="bg-purple-700 hover:scale-105 transition-all ease-in-out duration-1000 hover:cursor-pointer text-white rounded-lg p-5 py-7 shadow-lg">
          <h2 className="text-2xl font-bold mb-4">Starter eCommerce Package</h2>
          ...
          <ul className="space-y-2 mb-6 mt-4">
            ...
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Basic Training on Website Management
            </li>
          </ul>
          <Link to={`/contact?plan=starter`}>
        ...
        <div className="bg-purple-700 hover:scale-105 transition-all ease-in-out duration-1000 hover:cursor-pointer text-white rounded-lg p-5 py-7 shadow-lg">
          <h2 className="text-xl font-bold mb-4">Standard eCommerce Package</h2>
          <p className="text-3xl font-bold">₹9,999</p>
          <ul className="space-y-2 mb-6 mt-4">
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Everything in the Starter Package, plus:
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Up to 10 product categories
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Enhanced product search functionality
            </li>
            <li className="flex items-center">
            ...
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Basic Dashboard for Sales and Inventory Tracking
            </li>
            <li className="flex items-center">
        ...
        <div className="bg-purple-700 hover:scale-105 transition-all ease-in-out duration-1000 hover:cursor-pointer text-white rounded-lg p-5 py-7 shadow-lg">
          <h2 className="text-xl font-bold mb-4">Premium eCommerce Package</h2>
          <p className="text-3xl font-bold">₹14,999</p>
          <ul className="space-y-2 mb-6 mt-4">
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Everything in the Standard Package, plus:
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Blog integration for content marketing
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Up to 15 product categories
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Advanced product filtering and sorting
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Advanced Inventory Management System
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Dashboard for Sales, Inventory, and Customer Insights
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> User registration and login functionality
            </li>
            <li className="flex items-center">
            ...
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Detailed analytics and reporting tools
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> WhatsApp integration for customer support
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> 6 Months of Free Support
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Advanced Training on Analytics and Inventory Management
            </li>
          </ul>
        ...
        <div className="bg-purple-700 hover:scale-105 transition-all ease-in-out duration-1000 hover:cursor-pointer text-white rounded-lg p-5 py-7 shadow-lg">
          <h2 className="text-xl font-bold mb-4">Ultimate eCommerce Package</h2>
          <p className="text-3xl font-bold">₹19,999</p>
          <ul className="space-y-2 mb-6 mt-4">
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Everything in the Premium Package, plus:
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Up to 20 product categories
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Marketplace integration (Amazon, Flipkart, etc.)
            </li>
            <li className="flex items-center">
            ...
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> API integrations for third-party services
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> AI-driven product recommendations
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Multi-language support
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Dedicated account manager
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> 12 Months of Free Support
            </li>
            <li className="flex items-center">
              <IoIosCheckmark size={32} /> Comprehensive Marketing and Sales Strategy Consultation
            </li>
          </ul>
          <Link to={`/contact?plan=ultimate`}>
            <button className="w-full py-2 bg-white text-purple-700 rounded-lg font-semibold">
              Get Ultimate
            </button>
          </Link>
