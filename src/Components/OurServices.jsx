...
function OurServices() {
  ...
  const [hovertextNextDesc, setHovertextNext] = useState(false);
              ...
              >
                ...
                <div className="relative z-20">
                  ...
                  <div className="h-12 ">
                    ...
                    {  index===4 && ( <span className="uppercase hover:cursor-pointer hover:underline text-white text-xl lg:text-xl font-display tracking-tight font-extrabold">
